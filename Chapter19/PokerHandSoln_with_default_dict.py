...
"""
# revised version of straightflush using defaultdict
...
##    def has_straightflush(self): #author's original, overidden below
...
##        return False
    ...
    def has_straightflush(self): # new version using defaultdict
        """Checks whether this hand has a straight flush.
